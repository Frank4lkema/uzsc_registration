...
RSpec.describe 'Creating a new Player', type: :feature do
	...
	scenario 'Creating a new player',js:true do
		within("#new_user") do
	...
	scenario 'Creating a player that already exists',js:true do
		within("#new_user") do
	...
	scenario 'creating a new player without name',js:true do
		within("#new_user") do
	...
	scenario 'creating a new player without e-mail',js:true do
		within("#new_user") do
			fill_in 'E-mail', with: ''
